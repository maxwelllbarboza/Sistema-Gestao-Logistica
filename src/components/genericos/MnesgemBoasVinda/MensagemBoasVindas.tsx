...
export const MensagemBoasVindas = () => {
  ...
  return (
    <><Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', height: '30rem', }}>
      <Typography sx={{ fontWeight: 'bold', fontSize: '1.2rem' }}> Bem-vindo ao Sistema MaxCarga!</Typography>
      <Typography> Estamos felizes em tê-lo(a) conosco. Obrigado por utilizar o Sistema MaxCarga.</Typography>
      </Box>
