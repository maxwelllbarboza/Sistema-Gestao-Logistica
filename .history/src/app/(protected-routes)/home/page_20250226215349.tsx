  ...
  return (
    <Grid container spacing={3}>
      <Grid lg={3} sm={6} xs={12}>
        <CardBudget tittle="max" diff={12} trend="down" sx={{ height: '100%', borderRadius: 3 }} value="$24k" />
      </Grid>
      <Grid lg={3} sm={6} xs={12}>
        <CardBudget diff={16} trend="down" sx={{ height: '100%', borderRadius: 3 }} value="1.6k" />
      </Grid>
      <Grid lg={3} sm={6} xs={12}>
        <CardBudget sx={{ height: '100%', borderRadius: 3 }} value={75.5} />
      </Grid>
      <Grid lg={3} sm={6} xs={12}>
        <CardBudget sx={{ height: '100%', borderRadius: 3 }} value="$15k" />
      </Grid>
    </Grid>  
  )
}
