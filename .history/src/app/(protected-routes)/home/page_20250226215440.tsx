...
export default function Home () {
  return (
    <Grid container spacing={3}>
      ...
      <Grid lg={3} sm={6} xs={12}>
        <CardBudget tittle="max" imgAvatar= "" diff={12} trend="down" sx={{ height: '100%', borderRadius: 3 }} value={75.5} />
      </Grid>
      <Grid lg={3} sm={6} xs={12}>
        <CardBudget tittle="max" imgAvatar= "" sx={{ height: '100%', borderRadius: 3 }} value="$15k" />
      </Grid>
    </Grid>  
  )
}
